...
class CuisinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuisine" do
    assert_difference('Cuisine.count') do
      post cuisines_url, params: { cuisine: { description: @cuisine.description, image: @cuisine.image, title: @cuisine.title } }
    end
  ...
  test "should update cuisine" do
    patch cuisine_url(@cuisine), params: { cuisine: { description: @cuisine.description, image: @cuisine.image, title: @cuisine.title } }
